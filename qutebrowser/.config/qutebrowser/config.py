...
## pattern instead.
## Type: List of UrlPattern
c.content.blocking.whitelist = [ 'https://freecoursesite.com/*', 'https://gigacourse.com/?11', 'https://gigacourse.com/' ]
...
config.bind('gh', 'home')
config.bind('em', 'hint links spawn --detach mpv --no-video --force-window {hint-url}')
config.bind('ev', 'hint links spawn --detach mpv --force-window {hint-url}')
